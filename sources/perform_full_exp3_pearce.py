...
def perform_full_exp3_pearce():
    """Allows the user to launch the complete (control group + HPC lesioned group) third experiment of Pearce 1998 using the command line
        Two groups of agents with same parameters need to be trained on the first experiment of Pearce beforehand, using perform_full_pearce script.
    ...
    perform_group_exp3_pearce(env_params, ag_params, directory=sys.argv[1]+"/lesioned_group", show_plots=False, save_plots=True)
