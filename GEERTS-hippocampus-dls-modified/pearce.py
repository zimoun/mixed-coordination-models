...
results_folder = os.path.join('results', 'pearce', group)
    ...
    for ses in tqdm(range(11)):
        for trial in tqdm(range(4), leave=False):
            ...
            if trial == 0:
                ...
                # print("landmark_dist: ",g.landmark_location)
                # print("goal_state1: ",g.platform_state)
                # print("goal_state: ",g.grid.cart_coords[g.platform_state])
                # print("goal_state: ",g.grid.cart_coords[168])
